...
#define IDI_WARNING (cast(u16*) cast(uintptr) 32515)
#define IDC_CROSS (cast(u16*) cast(uintptr) 32515)
...
typedef sint (WINAPI *WNDPROC)(HWND, u32, uint, sint);
typedef struct {
	s32 x;
	s32 y;
} POINT;
...
#define USER32_FUNCTIONS \
	...
	X(sint, DispatchMessageW, MSG*) \
	X(HDC, GetDC, HWND) \
	X(s32, ValidateRect, HWND, RECT*) \
	X(s32, ClipCursor, RECT*) \
	X(sint, DefWindowProcW, HWND, u32, uint, sint) \
